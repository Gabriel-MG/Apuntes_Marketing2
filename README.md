...
Proceso social y de gestión a trabes de individuos que desean y necesitan productos o servicios, son técnicas sociales



## Conceptos básicos del marketing

1) Necesidad: la necesidad de algo

2) Deseo: La forma en que satisfaces la necesidad

3) Producto: Es con que satisfaces la necesidad

Propuesta de valor: el distintivo de algo, todo depende del público objetivo

## Dimensiones de la mezcla de productos

1) Profundidad:
    1) Diferentes variaciones dentro de cada tipo de producto.
2) Longitud:
    1) Diferentes productos dentro de cada tipo de Producto
3) Amplitud:
    1) Diferentes categorías del producto, ej: Bimbo: marinela
...
- Producto Básico: en el caso de un perfume, es el liquido debido a que lo que satisface es el oler bien, por tal motivo , el basico es el liquido
...
El empaque es un medio para comprar el producto

Niveles de empaque:
1) Primario: Contacto directo con el producto. ej: Perfume: envase
2) Secundario: El que contiene al empaque primario: ej: La caja de cartón o lata del perfume
3) Empaque de exhibición: Empaque que se muestra. ej: los pallets, cajas, tarimas
4) Empaque de envío: Los contenedores : 1 teu = twenty food equivalent Unit = 20 pies

### [Estrategia de la Marca.]
El objetivo de la marca es capturar el valor inherente y traducirlo al consumidor en términos de una amplia y completa comunicación.

Elementos críticos para el éxito de una marca:
- Diferenciación: que te diferencia de las competencias
- Mejor que la competencia
- Mayor valor para el cliente para el cliente en comparación con los otros
...
Se encarga de:
2) *Identificar:* en que segmento o segmentos de mercado hay que enfocarse.
3) *Consiste:* en determinar el espacio del mercado y el potencial de ventas.
